const narratives = [
  ...
  },
  {
    ...
    description:
      "From Pentecost to Philippi, the Spirit moves as the word is proclaimed. Hearts are changed, households rejoice, and the Spirit falls when the message is heard.",
